"""This module implements the body of the while loop of the ScanningGateRemovalPass."""
...
class OneGateRemovalPass(BasePass):
    """
    The OneGateRemovalPass class.

    Keeps instantiating until a gate is removed.
    In data, pass in the cycle
    """
    ...
    async def run(self, circuit: Circuit, data: PassData) -> None:
        ...
        all_ops = list(circuit.operations_with_cycles(reverse=reverse_iter))

        while ind < len(all_ops):
            cycle, op = all_ops[ind]
