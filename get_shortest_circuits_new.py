...
from util import AnalyzeBlockPass, SecondLEAPSynthesisPass, SubselectEnsemblePass, AnalyzeDistributionPass
    ...
    leap_workflow = [
        ...
        ForEachBlockPass(
            [
                ...
                SubselectEnsemblePass(success_threshold=err_thresh, num_circs=2000),
                AnalyzeDistributionPass(circ_name=circ_name, tol=tol),
                UnfoldPass()
            ],
        ...
        CreateEnsemblePass(success_threshold=err_thresh, num_circs=1000, cost=phase_generator, solve_exact_dists=False),
        UnfoldPass()
    ]
    num_workers = 256
...
if __name__ == '__main__':
    ...
    save_circuits(circs, circ_name, tol, timestep, ignore_timestep=True, extra_str=f"_{num_unique_circs}_circ_qfactor_subselect")