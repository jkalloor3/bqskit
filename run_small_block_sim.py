...
from sim_lib.sim_lib import (run_cudaq_nisq_circs, generate_lgt_hamiltonian_cudaq)
...
def get_sub_block_count(large_block_num: str, 
                        small_block_num: str, 
...
if __name__ == '__main__':
    ...
    for ens_size in ensemble_sizes:
        ...
        for large_block_num in large_block_nums:
            ...
            all_mags = run_cudaq_nisq_circs(circs=ens + [full_circ], 
                                            ham=ham, 
                                            add_coherent_error=COHERENT_ERROR, 
                                            use_noise=use_noise, 
                                            num_shots=num_shots, 
